...
function createGenericButton (div, title, onaction, minwidth)
{
	...
	element.src = 'apple/WidgetResources/button/glassbuttonleft.png';
	element.style.setProperty('white-space', 'nowrap', '');
	div.appendChild (element);
	
	element = document.createElement('div');
	element.setAttribute ("style", 'font:12px "Helvetica Neue";font-weight:bold;color:white;display:inline-block;vertical-align:bottom;text-align:center;line-height:23px;background:url(apple/WidgetResources/button/glassbuttonmiddle.png) repeat-x top left;');	
	element.style.setProperty('white-space', 'nowrap', '');
	div.appendChild (element);
	...
	element.src = 'apple/WidgetResources/button/glassbuttonright.png';
	element.style.setProperty('white-space', 'nowrap', '');
	div.appendChild (element);
	...
	var img = new Image;
	img.src = 'apple/WidgetResources/button/glassbuttonleftclicked.png';
	var img = new Image;
	img.src = 'apple/WidgetResources/button/glassbuttonmiddleclicked.png';
	var img = new Image;
	img.src = 'apple/WidgetResources/button/glassbuttonrightclicked.png';
}
...
function genericButtonMouseDownHandler(event, div)
{
	...
	{
		div.childNodes[0].src = 'apple/WidgetResources/button/glassbuttonleftclicked.png';
		div.childNodes[1].style.backgroundImage = 'url(apple/WidgetResources/button/glassbuttonmiddleclicked.png)';
		div.childNodes[2].src = 'apple/WidgetResources/button/glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOverHandler (event)
{
	...
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'apple/WidgetResources/button/glassbuttonleftclicked.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(apple/WidgetResources/button/glassbuttonmiddleclicked.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'apple/WidgetResources/button/glassbuttonrightclicked.png';
	}
...
function genericButtonMouseOutHandler (event)
{
	if (genericButtonCurrentMouseDownButton && genericButtonCurrentMouseDownButton.genericButtonEnabled)
	{
		genericButtonCurrentMouseDownButton.childNodes[0].src = 'apple/WidgetResources/button/glassbuttonleft.png';
		genericButtonCurrentMouseDownButton.childNodes[1].style.backgroundImage = 'url(apple/WidgetResources/button/glassbuttonmiddle.png)';
		genericButtonCurrentMouseDownButton.childNodes[2].src = 'apple/WidgetResources/button/glassbuttonright.png';
	}
